package com.teamkkumul.feature.meetupcreate.friend.viewholder
...
class MeetUpEditFriendViewHolder(
    ...
    fun onBind(data: MeetUpEditParticipantModel.Member, isSelected: Boolean) {
        with(binding) {
